...
VALID_TRANSITIONS: dict[VideoStage, list[VideoStage]] = {
    ...
    VideoStage.QA_RUNNING:       [VideoStage.RENDERING, VideoStage.MANIM_GENERATING, VideoStage.REJECTED],
    VideoStage.RENDERING:        [VideoStage.TTS_GENERATING, VideoStage.REJECTED],
    VideoStage.TTS_GENERATING:   [VideoStage.COMPOSING, VideoStage.REJECTED],
    VideoStage.COMPOSING:        [VideoStage.FINAL_REVIEW, VideoStage.REJECTED],
    ...
    VideoStage.REJECTED:         [VideoStage.IDEA_GENERATING],
}
